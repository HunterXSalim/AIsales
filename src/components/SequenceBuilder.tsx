    ...
    try {
      ...
      const stepsToInsert = sequenceSteps.map(step => ({
        ...
        prompt: step.channel_type === 'email' 
          ? `You are an AI appointment setter. Send professional emails to leads and book qualified appointments.`
                  ...
                  {step.channel_type === 'email' && (
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Hi [name],&#10;&#10;I noticed [company] is [context]. Would you be interested in a quick 15-minute call to discuss how we can help?&#10;&#10;Best regards,&#10;[your_name]"
                      />
                      <p className={`text-xs mt-1 ${
                        theme === 'gold' ? 'text-gray-500' : 'text-gray-500'
                      }`}>
                        Use variables: [name], [company], [job_title], [your_name]
                      </p>
                    </div>
                  )}
                </div>
