...
export function LeadsTracker() {
  ...
  const totalMetrics = performanceData.reduce((acc, performance) => ({
    ...
    totalEmails: acc.totalEmails + performance.activityStats.emails,
    totalBookings: acc.totalBookings + performance.activityStats.bookings,
  }), { totalLeads: 0, totalCalls: 0, totalMessages: 0, totalEmails: 0, totalBookings: 0 });
        ...
        <div className={`p-4 rounded-lg border ${
          ...
          <div className="flex items-center space-x-2 mb-2">
            <Mail className={`h-4 w-4 ${
              theme === 'gold' ? 'text-yellow-400' : 'text-indigo-600'
            }`} />
            <span className={`text-xs font-medium ${
              theme === 'gold' ? 'text-gray-400' : 'text-gray-600'
            }`}>
          ...
          <p className={`text-2xl font-bold ${
            ...
            {totalMetrics.totalEmails.toLocaleString()}
          </p>
        </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className={`p-4 rounded-lg ${
                  ...
                  <p className={`text-xl font-bold ${
                    ...
                    {performance.activityStats.sms + performance.activityStats.whatsapp + performance.activityStats.emails}
                  </p>
                </div>
