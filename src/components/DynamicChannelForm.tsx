          ...
          <>
            <div className={`p-4 rounded-lg border ${
              ...
              <p className={`text-sm ${
                ...
                For Gmail/GSuite, use your email as username and generate an App Password in your Google Account settings.
              </p>
            </div>
            ...
            {(formData.email_provider === 'smtp' || formData.email_provider === 'gmail') && (
              <>
                <div>
                  <label className={`block text-sm font-medium mb-2 ${
                    theme === 'gold' ? 'text-gray-300' : 'text-gray-700'
                  }`}>
                    {formData.email_provider === 'gmail' ? 'SMTP Host (Gmail)' : 'SMTP Host'} *
                  </label>
                  <input
                    type="text"
                    value={formData.smtp_host || (formData.email_provider === 'gmail' ? 'smtp.gmail.com' : '')}
                ...
                <div>
                  <label className={`block text-sm font-medium mb-2 ${
                    ...
                    {formData.email_provider === 'gmail' ? 'SMTP Port (Gmail)' : 'SMTP Port'} *
                  </label>
                  <input
                    type="number"
                    value={formData.smtp_port || (formData.email_provider === 'gmail' ? '587' : '')}
            ...
            <div>
              <label className={`block text-sm font-medium mb-2 ${
                ...
                {formData.email_provider === 'gmail' ? 'Gmail Address' : 'Email Username'} *
              </label>
              <input
                type="email"
                ...
                placeholder={formData.email_provider === 'gmail' ? 'your-email@gmail.com' : 'your-email@domain.com'}
                required
              />
            </div>
            ...
            <div>
              <label className={`block text-sm font-medium mb-2 ${
                ...
                {formData.email_provider === 'gmail' ? 'App Password (Gmail)' : 'Email Password'} *
              </label>
              <div className="relative">
                <input
                  ...
                  placeholder={formData.email_provider === 'gmail' ? 'App Password (16 characters)' : 'Password or App Password'}
                  required
                />
                <button
                  type="button"
            ...
            <div>
              ...
              <input
                ...
                placeholder={formData.email_provider === 'gmail' ? 'your-email@gmail.com' : 'sender@yourdomain.com'}
                required
              />
            </div>
